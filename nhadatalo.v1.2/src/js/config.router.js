        ...
        ['$stateProvider', '$urlRouterProvider', 'JQ_CONFIG',
            function($stateProvider, $urlRouterProvider, JQ_CONFIG) {
                ...
                .state('app.mail', {
                                    ...
                                    return $ocLazyLoad.load('ui.grid').then(
                                        function() {
                                            return $ocLazyLoad.load([
                                                'js/services/service.helper.js',
                                                'js/controllers/uigrid.js',
                                                'js/users/user.service.js',
                                                //'js/users/usermanagement.controller.js'
                                            ]);
                                        }
                                    );
                                }
                    ...
                    .state('management.settings.list', {
                        url: '/list',
                        templateUrl: 'js/settings/setting.list.html',
                            ...
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['ngGrid', 'toaster']).then(
                                        function() {
                                            return $ocLazyLoad.load([
                                                'js/base/grid.base.controller.js',
                                                'js/services/service.helper.js',
                                                'js/controllers/grid.js',
                                                'js/settings/setting.service.js',
                    ...
                    .state('management.settings.edit', {
                        // url: '/edit/{settingId:int}',
                        url: '/edit',
                        params: {
                            'setting': null
                        },
                        templateUrl: 'js/settings/setting.edit.html',
                            ...
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load('toaster').then(
                                        function() {
                                            return $ocLazyLoad.load([
                                                'js/base/base.service.js',
                                                'js/controllers/form.js',
                                                'js/services/service.helper.js',
                                                'js/settings/setting.service.js',
                                                'js/settings/setting.controller.js'
                                            ]);
                                        }
                                    );
                                }
                ...
                .state('management.categories', {
                    ...
                    .state('management.categories.list', {
                        url: '/list',
                        templateUrl: 'js/categories/category.list.html',
                                    ...
                                    return $ocLazyLoad.load(['ngGrid', 'toaster']).then(
                                        function() {
                                            return $ocLazyLoad.load([
                                                ...
                                                'js/services/service.helper.js',
                                                'js/controllers/grid.js',
                                                'js/categories/category.service.js',
                                                'js/categories/categories.controller.js'
                                            ]);
                                        }
                                    );
                                }
                    ...
                    .state('management.categories.edit', {
                        url: '/edit',
                        params: {
                            'category': null
                        },
                        templateUrl: 'js/categories/category.edit.html',
                        ...
                        resolve: {
                                    ...
                                    return $ocLazyLoad.load('toaster').then(
                                        function() {
                                            return $ocLazyLoad.load([
                                                ...
                                                'js/controllers/form.js',
                                                'js/categories/category.service.js',
                                                'js/categories/category.controller.js'
                                            ]);
                                        }
                                    );
                                }
                            ...
                            data: ['$resource', 'serviceHelperSvc', function($resource, serviceHelper) {
                                var resource = $resource(serviceHelper.buildUrl('api/categories/getparent'), null, {
                                    get_parent: {
                                        url: serviceHelper.buildUrl("api/categories/getparent?parentId=:parentId"),
                                        method: 'get',
                                        params: {
                                            parentId: '@parentId'
                                        },
                                ...
                                var parents = resource.get_parent({
                                    parentId: null
                                });
